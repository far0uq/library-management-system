...
namespace LOAS
{
    internal class HashCode
    {
        ...
        // Encrypted Password can be reverted into its original form
        // Hashed Password cannot, it can only be verified. i.e The password will only be checked with
        // original password that was hashed. To do this we only meed to hash the password again and tele it with
